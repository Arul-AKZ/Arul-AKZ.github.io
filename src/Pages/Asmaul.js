...
const Asmaul = () => {
  return (
    <>
    <Header/>
    <div className='text-center bg-center font-medium  text-3xl py-10 text-slate-500'>
      <h1>99 Asmaul Husna</h1>

      {/* bagian bawah */}
      <div class="flex flex-row gap-10 px-16 justify-center py-5">
  <div class="bg-white rounded-lg shadow-md p-4">
    <h2 class="font-bold text-lg mb-2">Ar rahim</h2>
  ...
  <div class="bg-white rounded-lg shadow-md p-4">
    <h2 class="font-bold text-lg mb-2">Al qudus</h2>
  ...
  <div class="bg-white rounded-lg shadow-md p-4">
    <h2 class="font-bold text-lg mb-2">As salam</h2>
